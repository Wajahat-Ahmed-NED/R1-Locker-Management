	...
	public newLockerMaintenance(final int chk) {
		...
		backButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (chk==0){	
<<<<<<<< HEAD:LockerManagementProject/.metadata/.plugins/org.eclipse.core.resources/.history/cb/2070325098a0001e1938f5416a3b89a7
				lockerModule obj=new lockerModule(0);
========
				newLockerModule obj=new newLockerModule(0);
>>>>>>>> 79ddf6e3e102d5c14b9e601923b157ae6acc5993:LockerManagementProject/LockerManagement/src/LockerManagement/newLockerMaintenance.java
				obj.setVisible(true);
				obj.setSize(600, 500);
				dispose();
				}
